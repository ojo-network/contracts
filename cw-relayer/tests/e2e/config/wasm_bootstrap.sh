...
echo $E2E_WASMD_USER_MNEMONIC | wasmd keys add user --recover --keyring-backend=test --home=$DEFAULT_HOME

wasmd add-genesis-account $(wasmd keys show val -a --keyring-backend=test --home $HOME) 1000000000000stake --home $HOME
wasmd add-genesis-account $(wasmd keys show user -a --keyring-backend=test --home $DEFAULT_HOME) 1000000000000stake --home $HOME
